...
def get_product(product_id):
    """
    Reads a Product
    This endpoint will read a Product from the database by id
    """
    app.logger.info(f"Reading a product for id: {product_id}")
...
def update_product(product_id):
    """
    Updates a Product
    This endpoint will update a Product using the data in the body that is passed
    """
...
def delete_product(product_id):
    """
    Deletes a Product
    This endpoint will delete a Product identifiy by the provided id
    """
